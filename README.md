...
| 系统 | 文件 | 说明 |
| --- | --- | --- |
| macOS（Apple Silicon） | `.app.zip` | M1/M2/M3/M4 原生版本；解压后拖入“应用程序” |
| macOS（Intel） | `.dmg` | Intel Mac；Apple Silicon 也可通过 Rosetta 运行 |
...
- `clodx-macos-arm64`：Apple Silicon 原生 `.app.zip`
